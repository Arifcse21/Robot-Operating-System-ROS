...
class RobotMover(object):
	...
	def __init__(self, value_BASE_PWM, value_MULTIPLIER_STANDARD, value_MULTIPLIER_PIVOT, value_simple_mode):
		rospy.Subscriber("/moveit_bot/cmd_vel", Twist, self.cmd_vel_callback)
		...
		rospy.wait_for_message("/raspicam_node/start_capture")
